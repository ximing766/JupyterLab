...
# ===================== 核心修复：数据采集与解析 =====================
def read_and_write_data(set_count, azimuth, test_count, ser, sheet, workbook, callback=None):
    count = 0
    count_los = 0
...
if __name__ == '__main__':
    ...
    for i in range(test_num+1):
        ...
        if ser is None:
            ...
            print(f"✅ UWB串口首次打开成功：{UWB_COM} @ {UWB_BAUDRATE}")
